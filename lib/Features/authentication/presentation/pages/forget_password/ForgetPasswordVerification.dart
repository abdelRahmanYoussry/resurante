            ...
            body: MainViewContainer(
              ...
              mainWidget: Column(
                ...
                children: [
                  ...
                  Text(
                    '${'${LocaleKeys.yourPhoneNumber.tr()} +201*******'} ',
                    style: TextStyle(
                      height: 1.3,
                      color: Theme.of(context).textTheme.bodyText1!.color,
                      fontSize: 16,
                  ...
                  MyElevatedButton(
                    ...
                    condition: state is! VerificationForgetPasswordLoadingState,
                    onTap: () async {
                      if (formKey.currentState!.validate()) {
                        cubit.verificationForgetPassword(
                        ...
                        // if (cubit.verificationForgetPasswordEntity.succeeded ==
                        //     true) {
                        //   showToast(
