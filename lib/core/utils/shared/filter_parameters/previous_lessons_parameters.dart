...
class StudentPreviousLessonsParameters extends Equatable {
  // Fields
  late int start;
  late int length;
  int? materialId;
  ...
  StudentPreviousLessonsParameters({
    ...
    required this.isAvailableClass,
    required this.isReservedClass,
    required this.isPreviousReserved,
    this.materialId,
    this.isRepeated,
    this.lessonDate,
    this.lessonTypeId,
  ...
  // Convert object to Map excluding null values
  Map<String, dynamic> toMap() {
    ...
    if (isFilterLessonDate != null)
      data['isFilterLessonDate'] = isFilterLessonDate;
    if (lessonFromTime != null)
      data['lessonFromTime'] = lessonFromTime?.toIso8601String();
    if (lessonToTime != null)
      data['lessonToTime'] = lessonToTime?.toIso8601String();
    if (isFilterLessonTime != null)
      data['isFilterLessonTime'] = isFilterLessonTime;
    ...
    if (sortPriceLowToHigh != null)
      data['sortPriceLowToHigh'] = sortPriceLowToHigh;
    if (sortPriceHighToLow != null)
      data['sortPriceHighToLow'] = sortPriceHighToLow;
    ...
    if (isPreviousReserved != null)
      data['isPreviousReserved'] = isPreviousReserved;
