...
//
//   @override
//   _NewCreditCardFormState createState() {
//     return _NewCreditCardFormState();
//   }
// }
//
// class _NewCreditCardFormState extends State<NewCreditCardForm> {
...
//                           return LocaleKeys.cardHolderValidation.tr();
//                         }
//                         return null;
//                       },
//                 ),
...
//                                 return LocaleKeys.validationDate.tr();
//                               }
//
...
//
//                               if (date.length != 2 ||
//                                   date.any((part) => part.isEmpty)) {
//                                 return LocaleKeys.validationDate.tr();
//                               }
//
//                               final int? month = int.tryParse(date.first);
//                               final int? year = int.tryParse('20${date.last}');
//
//                               if (month == null ||
//                                   year == null ||
//                                   month < 1 ||
...
//                                 return LocaleKeys.cvvValidation.tr();
//                               }
//                               return null;
//                             },
//                       ),
