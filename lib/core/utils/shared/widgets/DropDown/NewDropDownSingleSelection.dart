...
class NewDropDownTextField extends StatefulWidget {
  const NewDropDownTextField(
      ...
      : assert(
        ...
        super(key: key);
  const NewDropDownTextField.multiSelection(
      {Key? key,
      this.controller,
...
class _NewDropDownTextFieldState extends State<NewDropDownTextField>
  ...
  void initState() {
    ...
    _hintText = LocaleKeys.choose.tr();
      ...
      if (widget.isMultiSelection) {
        ...
        _cnt.text = (count == 0
            ...
            : widget.displayCompleteItem
                ...
                : "$count ${LocaleKeys.itemSelected.tr()}");
      } else {
  ...
  updateFunction({NewDropDownTextField? oldWidget}) {
  ...
  @override
  void didUpdateWidget(covariant NewDropDownTextField oldWidget) {
  ...
  clearFun() {
    ...
    if (widget.isMultiSelection) {
      ...
      if (widget.onChanged != null && widget.onChanged.toString().isNotEmpty) {
        widget.onChanged!("");
      }
    }
    setState(() {});
